...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
        ...
        holder.btnFollow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.btnFollow.getText().toString().equals(("follow"))){
                    FirebaseDatabase.getInstance("https://alumni-netwroking-app-default-rtdb.firebaseio.com/").getReference().child("Follow").
    ...
    private void isFollowed(final String id, final Button btnFollow) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://alumni-netwroking-app-default-rtdb.firebaseio.com/").getReference().child("Follow").child(firebaseUser.getUid())
                .child("following");
